...
| `decisions.md` | سجلّ القرارات المعمارية **D-001 → D-289** — كل قرار بسرده وجذره ودليله الحيّ. أحدثها: **D-289** (الحارسُ أستاذٌ لا رقابة) · **D-288** (القدرةُ لا تُطعِم طالباً) · **D-287** (الدفعة الآلية تسقط في بوّابةٍ لا تجتازها) · **D-286** · **D-285**. | سجلّ ملزِم |
| `issues.md` | سجلّ الكوارث المُشخَّصة والمُصلَحة **ISS-001 → ISS-201** — كلٌّ بجذرها ودليلها الحيّ وشرط إغلاقها. أحدثها: **ISS-201** (حارسٌ يمزّق الإجابة — ✅ D-289) · **ISS-200** (صدارةٌ بلا endpoint — ✅ D-288) · **ISS-199** · **ISS-198**. | سجلّ ملزِم |
