...
محاولةَ DSPy على مزوّدٍ ميت. و`OPENROUTER_BASE_URL` صار يقظةَ كلِّ العملاء (orchestrator ·
وكيلا `simple_client` · `super_search`) لأنّ تشخيص ISS-160 استحال بلا بوابةٍ تُوجَّه إلى مزدوج.
