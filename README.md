...
Issue and decision history: [`.memory/decisions.md`](.memory/decisions.md) (D-001 → D-289) · [`.memory/issues.md`](.memory/issues.md) (ISS-001 → ISS-201). Both are append-only records, including the failures — a disaster with no written root cause is not closed.
